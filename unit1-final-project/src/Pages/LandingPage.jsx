...
function LandingPage() {
    ...
    return(
        <main className='main-format'>
            ...
            <br />
            <p>
            Enjoy the concept? Navigate to the License page to download the application for free. Substitute your data in the CVData.js file in the utils folder to render your own CV. All objects are extensible. See the ReadMe for guidance on substituting your own information. Enjoy and be good.
            </p>
            </div>
            )}
